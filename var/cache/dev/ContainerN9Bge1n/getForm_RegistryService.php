...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\AddAnimeType' => function () {
    return ($this->privates['App\Form\AddAnimeType'] ?? $this->privates['App\Form\AddAnimeType'] = new \App\Form\AddAnimeType());
}, 'App\\Form\\AddEpisodeType' => function () {
    return ($this->privates['App\Form\AddEpisodeType'] ?? $this->privates['App\Form\AddEpisodeType'] = new \App\Form\AddEpisodeType());
}, 'App\\Form\\CreateGroupeType' => function () {
    return ($this->privates['App\Form\CreateGroupeType'] ?? $this->privates['App\Form\CreateGroupeType'] = new \App\Form\CreateGroupeType());
}, 'App\\Form\\GroupMemberType' => function () {
    return ($this->privates['App\Form\GroupMemberType'] ?? $this->privates['App\Form\GroupMemberType'] = new \App\Form\GroupMemberType());
}, 'App\\Form\\TchatType' => function () {
    return ($this->privates['App\Form\TchatType'] ?? $this->privates['App\Form\TchatType'] = new \App\Form\TchatType());
}, 'App\\Form\\UploadImageType' => function () {
    return ($this->privates['App\Form\UploadImageType'] ?? $this->privates['App\Form\UploadImageType'] = new \App\Form\UploadImageType());
}, 'App\\Form\\VideoType' => function () {
    return ($this->privates['App\Form\VideoType'] ?? $this->privates['App\Form\VideoType'] = new \App\Form\VideoType());

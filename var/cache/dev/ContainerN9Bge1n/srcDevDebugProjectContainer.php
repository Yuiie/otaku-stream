...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            'App\\Controller\\AddController' => 'getAddControllerService.php',
            'App\\Controller\\BuilderController' => 'getBuilderControllerService.php',
            'App\\Controller\\FeedController' => 'getFeedControllerService.php',
            ...
            'App\\Controller\\LevelController' => 'getLevelControllerService.php',
            'App\\Controller\\MainController' => 'getMainControllerService.php',
            'App\\Controller\\MessengerController' => 'getMessengerControllerService.php',
            ...
            'thruway.client' => 'getThruway_ClientService.php',
            'thruway.command.debug' => 'getThruway_Command_DebugService.php',
            'thruway.command.process' => 'getThruway_Command_ProcessService.php',
            'thruway.command.router' => 'getThruway_Command_RouterService.php',
            'thruway.command.worker' => 'getThruway_Command_WorkerService.php',
            'twig.controller.exception' => 'getTwig_Controller_ExceptionService.php',
            'twig.controller.preview_error' => 'getTwig_Controller_PreviewErrorService.php',
            'voryx.thruway.loop' => 'getVoryx_Thruway_LoopService.php',
            'voryx.thruway.resource.mapper' => 'getVoryx_Thruway_Resource_MapperService.php',
            'voryx.thruway.server' => 'getVoryx_Thruway_ServerService.php',
            'wamp_kernel' => 'getWampKernelService.php',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('v09Sfp5kGf', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pnc7Ik7-YM', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('wamp.open', array(0 => function () {
            return ($this->privates['voryx.thruway.topic_state_handler'] ?? $this->privates['voryx.thruway.topic_state_handler'] = new \Voryx\ThruwayBundle\TopicStateHandler());
        }, 1 => 'onOpen'), 0);
        $instance->addListener('kernel.response', array(0 => function () {
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-FBit2ijqV', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+Pe8lMavqu', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XLmucnRqXX', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ezxrp0SH9S', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'VoryxThruwayBundle' => array(
                    'path' => ($this->targetDirs[3].'\\vendor\\voryx\\thruway-bundle\\src\\Voryx\\ThruwayBundle'),
                    'namespace' => 'Voryx\\ThruwayBundle',
                ),
            ); break;
            case 'brochures_directory': $value = ($this->targetDirs[3].'/public/uploads/img/anime'); break;
            case 'img_user': $value = ($this->targetDirs[3].'/public/uploads/img/gallery'); break;
            case 'img_feed': $value = ($this->targetDirs[3].'/public/uploads/img/feed'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'VoryxThruwayBundle' => 'Voryx\\ThruwayBundle\\VoryxThruwayBundle',
            ),

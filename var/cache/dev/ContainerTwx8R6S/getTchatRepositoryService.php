...
// Returns the private 'App\Repository\TchatRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TchatRepository.php';

return $this->privates['App\Repository\TchatRepository'] = new \App\Repository\TchatRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

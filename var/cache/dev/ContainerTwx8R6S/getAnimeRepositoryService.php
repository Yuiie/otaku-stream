...
// Returns the private 'App\Repository\AnimeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AnimeRepository.php';

return $this->privates['App\Repository\AnimeRepository'] = new \App\Repository\AnimeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

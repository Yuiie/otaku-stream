...
// Returns the private 'App\Repository\MessengerRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\MessengerRepository.php';

return $this->privates['App\Repository\MessengerRepository'] = new \App\Repository\MessengerRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

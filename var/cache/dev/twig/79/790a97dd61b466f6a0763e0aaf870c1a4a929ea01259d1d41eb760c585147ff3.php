...
class __TwigTemplate_c0a8c4a78800e6f90e4adc440bcdd9024251ae5afdc0cb12776cb60b33508f68 extends Twig_Template
{
    private $source;
...
";
        ...
        <div class=\"card\" style=\"background-color:#ccccff; margin-top: 10px;\">
            ...
            echo "/";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["article"], "anime", array()), "id", array()), "html", null, true);
            echo "\">";
...
";
    ...
    {
        return array (  136 => 44,  128 => 38,  115 => 33,  111 => 32,  100 => 30,  94 => 27,  90 => 25,  86 => 24,  81 => 21,  72 => 20,  62 => 18,  54 => 11,  45 => 10,  15 => 1,);
    }
...
{% for article in listarticle %}
    <div class=\"col\">
        <div class=\"card\" style=\"background-color:#ccccff; margin-top: 10px;\">
            ...
            <div class=\"card-body\" style=\"text-align:center;\">
                <h4 class=\"card-title\">
                    <a class=\"nav-item\" href=\"{{ path('Anime') }}/{{ article.anime.id }}\">{{ article.nom }} {{ article.episode }}</a>
                </h4>
                <p class=\"card-text\"><a style=\"padding: 10px;\">{{ article.date|date(\"m/d/Y\") }}</a></p>
                <a href=\"{{ path('Anime') }}/{{ article.anime.id }}\" class=\"btn btn-primary\">See Profile</a>
            </div>
        </div>
    </div>
    {% endfor %}
...
{% endblock %}
", "main/index.html.twig", "C:\\laragon\\www\\Otaku-Stream\\templates\\main\\index.html.twig");
    }
}

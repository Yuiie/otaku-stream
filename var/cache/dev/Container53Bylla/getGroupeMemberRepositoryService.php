...
// Returns the private 'App\Repository\GroupeMemberRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\GroupeMemberRepository.php';

return $this->privates['App\Repository\GroupeMemberRepository'] = new \App\Repository\GroupeMemberRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));

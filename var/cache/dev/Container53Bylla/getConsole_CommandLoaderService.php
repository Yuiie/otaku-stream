...
}, 'thruway.command.debug' => function (): \Voryx\ThruwayBundle\Command\ThruwayDebugCommand {
    return ($this->services['thruway.command.debug'] ?? $this->load('getThruway_Command_DebugService.php'));
}, 'thruway.command.process' => function (): \Voryx\ThruwayBundle\Command\ThruwayProcessCommand {
    return ($this->services['thruway.command.process'] ?? $this->load('getThruway_Command_ProcessService.php'));
}, 'thruway.command.router' => function (): \Voryx\ThruwayBundle\Command\ThruwayRouterCommand {
    return ($this->services['thruway.command.router'] ?? $this->load('getThruway_Command_RouterService.php'));
}, 'thruway.command.worker' => function (): \Voryx\ThruwayBundle\Command\ThruwayWorkerCommand {
    return ($this->services['thruway.command.worker'] ?? $this->load('getThruway_Command_WorkerService.php'));

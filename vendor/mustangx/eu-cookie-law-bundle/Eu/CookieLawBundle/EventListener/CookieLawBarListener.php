...
namespace Eu\CookieLawBundle\EventListener;
...
use Eu\CookieLawBundle\Service\CookieLawService;

class CookieLawBarListener implements EventSubscriberInterface
{
    ...
    public function __construct(CookieLawService $cookieService, $cookieExpiryTime)
    {

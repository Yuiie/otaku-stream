...
namespace Eu\CookieLawBundle\Tests\Controller;

use Symfony\Bundle\FrameworkBundle\Test\WebTestCase;
use Symfony\Component\BrowserKit\Cookie;

class CookieLawControllerTest extends WebTestCase
{
    public function testIfCookieLawBarAppearsIfCookieIsNotSet()
    {
    ...
    public function testIfCookieLawBarAppearsIfCookieIsPresent()
    {
        $client = static::createClient();
